...
function Dropdown({
  ...
  classsNameLabel = 'truncate text-left text-dark-terteriary',
  classNameActiveLabel = 'text-dark-primary',
      ...
      >
        {({ open }) => (
          <div className={clsx(
            ...
            open ? 'border-primary ring-1 ring-primary' : 'border-dark-quaternary',
            className,
          )}
          >
            <div
            ...
            {options.length > 0 && (
              <div>
                {open
                  ? <MdExpandLess className={clsx('text-dark-terteriary ml-1.5', classNameIcon)} />
                  : <MdExpandMore className={clsx('text-dark-terteriary ml-1.5', classNameIcon)} />}
              </div>
            )}
          </div>
        )}
